...
export function ValuePropsTruthEngineV9() {
  const valueProps = [
    {
      stat: '2M+',
            ...
            {valueProps.map((prop, index) => (
              ...
              >
                ...
                <div className="relative">
                  <p
                    className="text-5xl bg-clip-text text-transparent mb-3"
                    style={{
                  ...
                  <h3
                    className="text-xl text-[#F2F5FA] mb-2"
                    style={{ fontFamily: 'Inter, system-ui, sans-serif', fontWeight: 400 }}
                  >
                    {prop.label}
                  </h3>
                  <p
                    className="text-[#BAD7F5]/60 leading-relaxed"
