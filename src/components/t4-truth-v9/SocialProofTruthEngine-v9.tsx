...
export function SocialProofTruthEngineV9() {
  ...
  return (
    <section className="relative bg-[#10131C] py-12 border-t border-white/[0.06] overflow-hidden">
      <div className="mx-auto px-10">
        {/* Just the logo slider - no header since text is above in hero, no stats since they're below */}
          ...
          <div className="overflow-hidden">
            ...
            >
              ...
              {logos.map((logo, i) => (
                ...
                >
                  <span
                    className="text-[#BAD7F5] text-lg tracking-wide"
