...
export function FeaturesTruthEngineV9() {
  const features = [
    {
      title: 'Strukturert søk & filtrering',
      description: 'Filtrer organisasjoner basert på bransje, størrelse, vekst, eierskap, roller, økonomi og historikk.',
      icon: <SearchFilterIcon />,
    },
    {
      title: 'Organisasjonsprofiler med sporbarhet',
      description: 'Se datapunkter om organisasjoner samlet i én visning – med klare felt, beskrivelser og kilder.',
      icon: <ProfileIcon />,
    },
    {
      title: 'Rolle- og personinformasjon',
      description: 'Få oversikt over nøkkelroller, styre og relasjoner mellom organisasjoner der data finnes.',
      icon: <PeopleIcon />,
    },
    {
      title: 'Lister & eksport',
      description: 'Bygg datadrevne segmenter og eksporter dem til CSV når innsikten skal brukes videre i organisasjonen.',
      icon: <ExportIcon />,
    },
  ]
      ...
      <div style={{ padding: '0 70px' }}>
        <div className="mx-auto" style={{ maxWidth: 'calc(100% - 140px)' }}>
          <div className="text-center mb-16">
            <h2
              className="text-3xl sm:text-4xl text-[#F2F5FA] tracking-tight"
            ...
            {features.map((feature, index) => (
              ...
              >
                ...
                <div className="relative">
                  ...
                  <h3
                    className="text-lg text-[#F2F5FA] mb-2"
                    style={{ fontFamily: 'Inter, system-ui, sans-serif', fontWeight: 400 }}
                  >
                    {feature.title}
                  </h3>
                  <p
                    className="text-sm text-[#BAD7F5]/60 leading-relaxed"
                    style={{ fontFamily: 'Inter, system-ui, sans-serif', fontWeight: 300 }}
                  >
                    {feature.description}
                  </p>
