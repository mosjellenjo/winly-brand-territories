...
import type { PlayfulSocialProofContentV2 } from "@/lib/content/t3-playful-v2";

interface SocialProofPlayfulV2Props {
  content: PlayfulSocialProofContentV2;
}

export function SocialProofPlayfulV2({ content }: SocialProofPlayfulV2Props) {
  return (
