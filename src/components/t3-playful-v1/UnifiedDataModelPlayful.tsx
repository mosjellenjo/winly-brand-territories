...
import type { PlayfulUnifiedDataModelContent } from "@/lib/content/t3-playful-v1";

interface UnifiedDataModelPlayfulProps {
  content: PlayfulUnifiedDataModelContent;
}

export function UnifiedDataModelPlayful({ content }: UnifiedDataModelPlayfulProps) {
  return (
    <section className="relative overflow-hidden bg-playful-bg py-20 lg:py-28">
      {/* Decorative elements */}
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute right-0 top-1/4 h-96 w-96 rounded-full bg-playful-purple-soft opacity-40 blur-3xl" />
        <div className="absolute bottom-0 left-0 h-80 w-80 rounded-full bg-playful-pink-soft opacity-30 blur-3xl" />
      </div>
        ...
        <div className="lg:grid lg:grid-cols-2 lg:items-center lg:gap-16">
          ...
          >
            <div className="relative">
              ...
              <div className="relative rounded-3xl border border-playful-border bg-playful-surface p-8 shadow-playful">
