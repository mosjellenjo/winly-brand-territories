...
import type { PlayfulFinalCtaContent } from "@/lib/content/t3-playful-v1";

interface FinalCtaPlayfulProps {
  content: PlayfulFinalCtaContent;
}

export function FinalCtaPlayful({ content }: FinalCtaPlayfulProps) {
  return (
