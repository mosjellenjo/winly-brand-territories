import { SalesIcon, MarketingIcon, ConsultantIcon } from './icons'
...
export function UseCasesT2CalmV5() {
  return (
        ...
        <div className="space-y-12">
          ...
          <div className="grid gap-6 lg:grid-cols-2">
            ...
            <div className="relative overflow-hidden rounded-2xl border border-calm3-border bg-white p-8 shadow-[var(--shadow-calm3-card)] transition-all hover:translate-y-[2px] hover:shadow-[var(--shadow-calm3-card-hover)] hover:ring-1 hover:ring-calm3-green-soft/60 lg:row-span-2">
              ...
              <div className="pl-4">
                <div className="mb-5 flex h-14 w-14 items-center justify-center rounded-2xl bg-calm3-orange-soft">
                  <SalesIcon size={28} className="text-calm3-orange-deep" />
                </div>
            ...
            {useCases.slice(1).map((useCase) => (
              ...
              >
                ...
                <div className="pt-2">
                  <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-calm3-orange-soft/70">
                    <useCase.Icon size={24} className="text-calm3-orange-deep" />
                  </div>
