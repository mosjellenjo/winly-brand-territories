import { OrganizationIcon, ContactIcon, OwnershipIcon, TenderIcon } from './icons'
...
export function UnifiedDataModelT2CalmV5() {
  return (
          ...
          <div className="relative">
            ...
            <div className="relative grid gap-6 md:grid-cols-2 lg:grid-cols-4">
              {dataPoints.map((point) => (
                ...
                >
                  <div className="mb-4 mx-auto flex h-14 w-14 items-center justify-center rounded-full bg-calm3-green-soft">
                    <point.Icon size={28} className="text-calm3-green-deep" />
                  </div>
