...
const useCases = [
  {
    ...
    description:
      "Bygg målrettede lister basert på bransje, størrelse, vekst og andre signaler. Se hvem som matcher din ideelle kundeprofil – og hvem du skal kontakte først.",
    features: [
      "Avansert søk og filtrering",
      "Lagre og del segmenter",
      "Eksporter til CRM",
      "Varsler på nye matcher",
    ],
  },
  {
    id: "enrichment",
    ...
    description:
      "Berik eksisterende data med oppdatert informasjon om selskaper og kontakter. Hold CRM-et ditt rent og komplett uten manuelt arbeid.",
    features: [
      "API og direkteintegrasjoner",
  ...
  },
  {
    id: "monitoring",
    title: "Monitorering",
    subtitle: "Aldri gå glipp av en mulighet",
    description:
      "Følg med på endringer hos kunder og prospekter. Få varsler om rollebytte, vekst, nye anbud og andre hendelser som åpner for dialog.",
    features: [
      "Sanntidsvarsler",
      "Tilpassede triggere",
      "Slack og e-post-integrasjon",
  ...
  },
  {
    ...
    description:
      "Finn relevante anbud før konkurrentene. Se historikk, tildelinger og sammenlign med lignende utlysninger for å øke vinnersannsynligheten.",
    features: [
...
export function UseCasesModernTechV5() {
      ...
      <div className="relative mx-auto max-w-6xl px-6">
        ...
        >
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg text-[#A0AEC0]">
            Fra å finne nye prospekter til å vinne offentlige anbud – Winly støtter hele kundereisen.
          </p>
        </motion.div>
