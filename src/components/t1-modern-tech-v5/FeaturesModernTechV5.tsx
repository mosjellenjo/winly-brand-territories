...
const features = [
  {
    title: "Lynrask søk",
    description: "Søk på tvers av millioner av datapunkter på millisekunder. Finn det du leter etter uten ventetid.",
    icon: (
  ...
  },
  {
    ...
    description: "Data som oppdateres kontinuerlig fra offisielle kilder. Alltid oppdatert, alltid pålitelig.",
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description: "Kombiner hundrevis av filtre for å finne akkurat det du leter etter. Bransje, geografi, vekst og mer.",
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description: "Bli varslet om endringer som betyr noe. Nye anbud, rollebytter, vekstsignaler og mer.",
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description: "Eksporter til Excel, CRM eller andre systemer. Data når og der du trenger det.",
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  {
    title: "API-tilgang",
    description: "Bygg egne løsninger med vårt robuste API. Full tilgang til alle datatyper og funksjoner.",
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
export function FeaturesModernTechV5() {
  return (
      ...
      <div className="relative mx-auto max-w-6xl px-6">
        ...
        >
          <h2 className="text-3xl font-bold tracking-tight text-white sm:text-4xl md:text-5xl">
            Bygget for fart og presisjon
          </h2>
          <p className="mx-auto mt-6 max-w-2xl text-lg text-[#A0AEC0]">
            Alt du trenger for å jobbe effektivt med B2B-data – uten kompromisser.
          </p>
        </motion.div>
