...
export function FinalCtaTruthEngineV6() {
        ...
        <div className="mx-auto" style={{ maxWidth: 'calc(100% - 140px)' }}>
          <div className="mx-auto max-w-3xl text-center">
            ...
            <div className="mt-12">
              <a
                href="#"
                className="inline-flex items-center justify-center px-8 py-4 text-lg font-normal text-[#121111] rounded-full transition-all hover:opacity-90"
