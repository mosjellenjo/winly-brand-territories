...
const dataLayers = [
  {
    title: "Bedriftsdata",
    items: ["Regnskap og nøkkeltall", "Bransje og geografi", "Eierstruktur og konsern"],
    color: "#4DF3FF",
  },
  {
    title: "Persondata",
    items: ["Roller og stillinger", "Kontaktinformasjon", "Beslutningsansvar"],
    color: "#B875FF",
  },
  {
    title: "Anbudsdata",
    items: ["Offentlige utlysninger", "Kontrakter og tildelinger", "Frister og historikk"],
    color: "#4DF3FF",
  },
];

export function UnifiedDataLayerV7() {
  return (
      ...
      <div className="relative mx-auto max-w-6xl px-6">
        ...
        >
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg text-[#A0AEC0]">
            De fleste tar beslutninger som om markedet er statisk. Winly viser hvordan selskaper, eiere og mennesker endrer seg over tid.
          </p>
        </motion.div>
        ...
        >
          <div className="relative rounded-2xl border border-white/5 bg-[#050709] px-8 py-4">
            <div className="flex items-center gap-4 text-sm text-[#A0AEC0]">
              ...
              <span>Se relasjoner på tvers av datalagene</span>
