...
const valueProps = [
  {
    ...
    description: "Bedrifter, personer og anbud – i én plattform uten siloer og manuelle steg.",
  },
  {
    icon: (
      <svg className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    description: "Søk og filtrer på bransje, geografi, rolle og vekstsignaler – på sekunder.",
  },
  {
    icon: (
      <svg className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    description: "Bygg lister med ekte signaler – vekst, ansettelser og aktive behov.",
  },
];

export function ValuePropsModernTechV7() {
  return (
      ...
      <div className="relative mx-auto max-w-6xl px-6">
        ...
        >
          <h2 className="text-3xl font-bold tracking-tight text-white sm:text-4xl md:text-5xl">
            Din digitale tvilling av norsk næringsliv
          </h2>
          <p className="mx-auto mt-6 max-w-2xl text-lg text-[#A0AEC0]">
            Få røntgenblikk på hele det norske B2B-markedet – i én struktur.
          </p>
        </motion.div>
