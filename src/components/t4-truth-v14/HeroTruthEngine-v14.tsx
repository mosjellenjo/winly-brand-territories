...
export function HeroTruthEngineV14() {
  ...
  useEffect(() => {
    ...
    const draw = () => {
      ...
      // Mouse-tracking glow points at grid intersections (keeping this, removing spark dots)
      ...
      // REMOVED: Spark dots effect entirely
  ...
  return (
    <section className="relative min-h-screen bg-[#10131C] overflow-hidden">
      ...
      {/* Hero Content - increased left margin */}
      <div className="relative z-10 pt-40 pb-20" style={{ padding: '160px 70px 80px 90px' }}>
        <div className="mx-auto" style={{ maxWidth: 'calc(100% - 140px)' }}>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            {/* Right: Preview Panel with marble3.jpg background - LOCKED SIZE */}
            <div className="relative flex justify-center lg:justify-end">
              <div className="relative w-full max-w-[600px]">
                {/* Marble background image - marble3.jpg with LOCKED size */}
                <div
...
function WorkflowStep({
  ...
  // Arrow extends more when hovered
  const arrowExtend = isHovered ? 28 : (showActiveState ? 20 : 12)
  ...
  return (
    <li
      ...
      style={{
        // Arrow shape with dynamic extension on hover
    ...
    >
      ...
      {/* Complete outline including corners */}
      <div
      ...
      >
        {/* Left edge - full height with rounded corners */}
        <div
        ...
        <div
          ...
          style={{ borderColor: 'rgba(75, 182, 211, 0.6)' }}
        />
        {/* Bottom-left corner arc */}
        <div
          className="absolute bottom-0 left-0 w-3 h-3 border-b border-l rounded-bl-xl"
          style={{ borderColor: 'rgba(75, 182, 211, 0.6)' }}
        />
        {/* Top edge with fade */}
        <div
          className="absolute top-0 left-3 h-px"
          style={{
            width: 'calc(85% - 12px)',
        ...
        <div
          className="absolute bottom-0 left-3 h-px"
          style={{
            width: 'calc(85% - 12px)',
            background: 'linear-gradient(90deg, rgba(75, 182, 211, 0.6) 0%, rgba(75, 182, 211, 0.3) 60%, transparent 100%)',
          }}
