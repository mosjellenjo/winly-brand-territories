...
export function DataTransparencySectionV5() {
  const trustPoints = [
    {
      ...
      <div className="px-5">
        <div className="mx-auto max-w-[1800px]">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            {/* Left: Content */}
            <div>
              <h2 className="text-3xl sm:text-4xl font-normal text-[#BAD7F5] tracking-tight mb-6">
                Bygget for{' '}
                <span
              ...
              <div className="space-y-6">
                {trustPoints.map((point, index) => (
                  <div key={index} className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="text-base font-medium text-[#BAD7F5] mb-1">{point.title}</h3>
            ...
            <div className="relative">
              ...
              <div className="relative rounded-2xl border border-white/10 bg-[#0F1219] overflow-hidden p-8">
                {/* Data source example */}
...
function DataRow({ label, value, verified = false }: { label: string; value: string; verified?: boolean }) {
  return (
    <div className="flex items-center justify-between">
      ...
      <div className="flex items-center gap-2">
        <span className="text-sm text-[#BAD7F5]">{value}</span>
        {verified && (
